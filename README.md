...
| 💰 省流节点 | url-test 75ms | `economy` 标签机场中过滤 实验性 / 1x 倍率 / 流媒体 关键词节点 |
| 🚄 Speedtest | select | 测速专用，默认直连（避免节点带宽干扰读数） |
...
| 🇭🇰 香港 | 🇹🇼 台湾 | 🇯🇵 日本 | 🇸🇬 狮城 | 🇺🇸 美国 | 🇬🇧 英国 | 🇺🇳 小众 |
|:------:|:------:|:------:|:------:|:------:|:------:|:------:|
| fallback | fallback | fallback | fallback | fallback | fallback | select |

`🇺🇳 小众` 不分层，直接从 `manual` 标签机场按关键词（喀麦隆 / 冰岛 / 土耳其 / 阿根廷 / 印度）筛选。

### 服务

| 策略组 | 默认节点 | 类别 |
|:-------|:---------|:-----|
| 🧠 AI 服务 | 日本·优选 → 台湾·优选 → 美国·优选 → 手动切换 | AI |
| ▶️ 油管视频 | 省流节点 | 流媒体 |
| 🎥 奈飞视频 | 省流节点 | 流媒体 |
| 📱 TikTok | 省流节点 | 流媒体 |
| 🎧 Spotify | 省流节点 | 流媒体 |
...
| 🪟 微软服务 | 全球直连 | 平台 |
| ☁️ 微软云盘 | 全球直连 | 平台 |
| 🎮 游戏平台 | 香港 → 狮城 → 台湾 → 日本 → 节点选择 → 手动切换 → 全球直连 | 游戏 |
| 🏦 香港金融 | 香港节点 | 金融 |
| 🅿️ PayPal | 美国节点 | 金融 |
| 🦉 Wise | 全球直连 | 金融 |
| 🪙 Crypto | 狮城节点 | 金融 |
...
| 7 | 自定义覆写 | 阿里 SDK UDP 探测拦截、NotebookLM / Google AI 定向、Apple Intelligence 定向、AutoDesk 拦截 |
